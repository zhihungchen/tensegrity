...
#include "tensegrity_interfaces/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tensegrity_interfaces::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tensegrity_interfaces::msg::State & ros_message)
{
  // Member: trajectory
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tensegrity_interfaces::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tensegrity_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tensegrity_interfaces::msg::State *>(
    untyped_ros_message);
...
get_message_type_support_handle<tensegrity_interfaces::msg::State>()
{
  return &tensegrity_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tensegrity_interfaces, msg, State)() {
  return &tensegrity_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
