...
#include "tensegrity_interfaces/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tensegrity_interfaces::msg::Trajectory & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.trajectory_segment;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tensegrity_interfaces::msg::Trajectory & ros_message)
{
  // Member: trajectory
  {
    uint32_t cdrSize;
  ...
  // Member: coms
  {
    ...
    ros_message.coms.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.coms[i]);
    }
  }
  ...
  // Member: pas
  {
    ...
    ros_message.pas.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.pas[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: coms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        geometry_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.coms[index], current_alignment);
    }
  }
  // Member: pas
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        geometry_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.pas[index], current_alignment);
    }
  }
  // Member: trajectory_segment
  {
    size_t item_size = sizeof(ros_message.trajectory_segment);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tensegrity_interfaces::msg::Trajectory;
    is_plain =
      (
      offsetof(DataType, trajectory_segment) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tensegrity_interfaces::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tensegrity_interfaces::msg::Trajectory *>(
    untyped_ros_message);
...
get_message_type_support_handle<tensegrity_interfaces::msg::Trajectory>()
{
  return &tensegrity_interfaces::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tensegrity_interfaces, msg, Trajectory)() {
  return &tensegrity_interfaces::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
