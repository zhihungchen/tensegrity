...
#include "tensegrity_interfaces/msg/detail/node__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tensegrity_interfaces::msg::Node;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const tensegrity_interfaces::msg::Node *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tensegrity_interfaces::msg::Node *>(
    untyped_ros_message);
...
{
  return &tensegrity_interfaces::msg::typesupport_fastrtps_cpp::_Node__handle;
}
