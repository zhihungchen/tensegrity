...
bool tensegrity_interfaces__msg__nodes_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tensegrity_interfaces.msg._nodes_stamped.NodesStamped", full_classname_dest, 53) == 0);
  }
  tensegrity_interfaces__msg__NodesStamped * ros_message = _ros_message;
  {  // header
  ...
  {  // reconstructed_nodes
    PyObject * field = PyObject_GetAttrString(_pymsg, "reconstructed_nodes");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'reconstructed_nodes'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    tensegrity_interfaces__msg__Node * dest = ros_message->reconstructed_nodes.data;
  ...
  {  // mocap_nodes
    PyObject * field = PyObject_GetAttrString(_pymsg, "mocap_nodes");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'mocap_nodes'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    tensegrity_interfaces__msg__Node * dest = ros_message->mocap_nodes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!tensegrity_interfaces__msg__node__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of NodesStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tensegrity_interfaces.msg._nodes_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NodesStamped");
  ...
  {  // reconstructed_nodes
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->reconstructed_nodes.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "reconstructed_nodes", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // mocap_nodes
    ...
    tensegrity_interfaces__msg__Node * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->mocap_nodes.data[i]);
      PyObject * pyitem = tensegrity_interfaces__msg__node__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "mocap_nodes", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
