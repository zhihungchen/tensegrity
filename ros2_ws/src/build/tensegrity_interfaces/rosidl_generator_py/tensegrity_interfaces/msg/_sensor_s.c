...
bool tensegrity_interfaces__msg__sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tensegrity_interfaces.msg._sensor.Sensor", full_classname_dest, 40) == 0);
  }
  tensegrity_interfaces__msg__Sensor * ros_message = _ros_message;
  {  // id
  ...
  {  // capacitance
    PyObject * field = PyObject_GetAttrString(_pymsg, "capacitance");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->capacitance = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * tensegrity_interfaces__msg__sensor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tensegrity_interfaces.msg._sensor");
  ...
  {  // capacitance
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->capacitance);
    {
      int rc = PyObject_SetAttrString(_pymessage, "capacitance", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
