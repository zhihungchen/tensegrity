...
bool tensegrity_interfaces__msg__imu_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tensegrity_interfaces.msg._imu_stamped.ImuStamped", full_classname_dest, 49) == 0);
  }
  tensegrity_interfaces__msg__ImuStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ImuStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tensegrity_interfaces.msg._imu_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImuStamped");
