...
#include "tensegrity_interfaces/msg/detail/node__rosidl_typesupport_fastrtps_c.h"
...
using _Node__ros_msg_type = tensegrity_interfaces__msg__Node;
...
static uint32_t _Node__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tensegrity_interfaces__msg__Node(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tensegrity_interfaces__msg__Node;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Node__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tensegrity_interfaces__msg__Node(
