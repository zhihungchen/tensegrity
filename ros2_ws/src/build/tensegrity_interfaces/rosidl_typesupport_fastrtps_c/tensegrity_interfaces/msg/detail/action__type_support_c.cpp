...
#include "tensegrity_interfaces/msg/detail/action__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // coms, endcaps, pas
...
using _Action__ros_msg_type = tensegrity_interfaces__msg__Action;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: coms
  {
    ...
    size_t size = ros_message->coms.size;
    auto array_ptr = ros_message->coms.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: pas
  {
    ...
    size_t size = ros_message->pas.size;
    auto array_ptr = ros_message->pas.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: endcaps
  {
    ...
    size_t size = ros_message->endcaps.size;
    auto array_ptr = ros_message->endcaps.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: coms
  {
    ...
    if (ros_message->coms.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->coms);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->coms, size)) {
      fprintf(stderr, "failed to create array for field 'coms'");
      return false;
    }
    auto array_ptr = ros_message->coms.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: pas
  {
    ...
    if (ros_message->pas.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->pas);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->pas, size)) {
      fprintf(stderr, "failed to create array for field 'pas'");
      return false;
    }
    auto array_ptr = ros_message->pas.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: endcaps
  {
    ...
    if (ros_message->endcaps.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->endcaps);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->endcaps, size)) {
      fprintf(stderr, "failed to create array for field 'endcaps'");
      return false;
    }
    auto array_ptr = ros_message->endcaps.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_tensegrity_interfaces__msg__Action(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Action__ros_msg_type * ros_message = static_cast<const _Action__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name coms
  {
    size_t array_size = ros_message->coms.size;
    auto array_ptr = ros_message->coms.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
  ...
  // field.name pas
  {
    size_t array_size = ros_message->pas.size;
    auto array_ptr = ros_message->pas.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
  ...
  // field.name endcaps
  {
    size_t array_size = ros_message->endcaps.size;
    auto array_ptr = ros_message->endcaps.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
...
static uint32_t _Action__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tensegrity_interfaces__msg__Action(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tensegrity_interfaces
size_t max_serialized_size_tensegrity_interfaces__msg__Action(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tensegrity_interfaces__msg__Action;
    is_plain =
      (
...
static size_t _Action__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tensegrity_interfaces__msg__Action(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tensegrity_interfaces, msg, Action)() {
